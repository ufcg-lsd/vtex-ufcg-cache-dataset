...
[One-hour anonymized sample](https://drive.google.com/drive/folders/1Rj0pB_3BS9Irp2cxl7pLLxl1Tc7lcVC4?usp=sharing)
...
|:------------------:|:---------:|:-----------------------------------------------------------------:|
|  Request Timestamp | Timestamp | The Unix timestamp of the request arrival time at the cache layer (anonymized microseconds)|
